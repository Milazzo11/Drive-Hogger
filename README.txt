This is a prank "virus" that will silently fill up a computer with lots of data.
The Python script will continue to copy the data.txt into the hidden "slowfiles" folder.

The current program allows users to enter the amount of data they wish to fill and execute the program,
